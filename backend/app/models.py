...
class User(Base):
    ...
    diagnostic_completed_at: Mapped[Optional[datetime]] = mapped_column(
...
class Problem(Base):
    ...
    skills: Mapped[List["ProblemSkill"]] = relationship(
...
class ProblemSkill(Base):
    ...
    problem_skill_id: Mapped[int] = mapped_column(
        Integer, primary_key=True, autoincrement=True
    )
    problem_id: Mapped[int] = mapped_column(
    ...
    skill_id: Mapped[int] = mapped_column(
        ForeignKey("skills.skill_id", ondelete="CASCADE"), nullable=False
    )
...
class DiagnosticItem(Base):
    ...
    problem_id: Mapped[Optional[int]] = mapped_column(
        ForeignKey("problems.problem_id", ondelete="SET NULL")
    )
...
class Metric(Base):
    ...
    score_time_complexity: Mapped[int] = mapped_column(
...
class HintTemplate(Base):
    ...
    hint_template_id: Mapped[int] = mapped_column(
        Integer, primary_key=True, autoincrement=True
    )
    problem_id: Mapped[int] = mapped_column(
        ForeignKey("problems.problem_id", ondelete="CASCADE"), nullable=False
...
class HintRequest(Base):
    ...
    hint_request_id: Mapped[int] = mapped_column(
        Integer, primary_key=True, autoincrement=True
    )
    user_id: Mapped[int] = mapped_column(
        ForeignKey("users.user_id", ondelete="CASCADE"), nullable=False
...
class UserSkillHistory(Base):
    ...
    user_skill_history_id: Mapped[int] = mapped_column(
        Integer, primary_key=True, autoincrement=True
    )
    user_id: Mapped[int] = mapped_column(
        ForeignKey("users.user_id", ondelete="CASCADE"), nullable=False
...
class ProblemStatus(Base):
    ...
    problem_status_id: Mapped[int] = mapped_column(
        Integer, primary_key=True, autoincrement=True
    )
    user_id: Mapped[int] = mapped_column(
        ForeignKey("users.user_id", ondelete="CASCADE"), nullable=False
...
class AiSolution(Base):
    ...
    ai_solution_id: Mapped[int] = mapped_column(
        Integer, primary_key=True, autoincrement=True
    )
    problem_id: Mapped[int] = mapped_column(
        ForeignKey("problems.problem_id", ondelete="CASCADE"), nullable=False
